                ...
                <div className='con'>
                    <div className='cont_box flex flex_wrap_wrap'>
                        ...
                        <div className='sub_tit'>주요경력</div>
                            <ul>
                                <li className='dots_w' style={z_first}>2021.06 ~ 2022.02 국민권익위원회 홈페이지·업무포털 전면개편 사업 (초급 JAVA개발, 퍼블리셔)</li>
                                <li className='dots_w' style={z_first}>2020.12 ~ 2021.03 부패방지 종합정보시스템 구축3단계 (퍼블리셔)</li>
                                <li className='dots_w' style={z_first}>2020.04 ~ 2020.10 스마트기기 UXUI디자인 양성과정</li>
                                <li className='dots_w' style={z_first}>2009.03 ~ 2015.02 배재대학교 칠예과 졸업</li>
                            </ul>
                        </div>
                    </div>
                </div>
