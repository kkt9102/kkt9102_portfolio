                    ...
                    <div className='cont_box flex flex_wrap_wrap'>
                        ...
                        <div className='txt_box intro'>
                            <ul style={z_first}>
                                ...
                                <li className="res_li_txt">웹 페이지의 뼈대인 HTML로 웹 페이지의 뼈대를 잡고</li>
                                <li className="res_li_txt">그 뼈때 위에 CSS를 이용하여 살과 옷을 입혀주고</li>
                                <li className="res_li_txt">JavaScript를 이용하여 웹 페이지에 움직임 주는 것을 좋아합니다.</li>
                                <li>웹 페이지를 만들때 혼자만의 세상에서 작업을 진행하지 않고 항상 팀원들과 소통하며 작업을 진행합니다.</li>
                                <li>코드짜는것을 즐거워하며 더 쉽고 간결한 코드를 짜기위해 고민합니다.</li>
                                <li className="res_li_txt">그리고 웹 페이지에 움직임을 주는 것에 그치지 않고 프로그래밍 언어와 DataBase를 사용하여</li>
                                <li className="res_li_txt">사용자들에게 보여줄 수 있는 웹 페이지를 만들기 위해 현재 자리에서 멈추지 않고 전진하고 있습니다.</li>
                            </ul>
                        <div className='sub_tit'>주요경력</div>
                            <ul>
                                ...
                                <li className='dots_w flex' style={z_first}><span className="date">2021.03 ~ 2022.03</span> (주)에이블 정보기술 기업부설연구소 근무</li>
                                <li className='dots_w flex' style={z_first}><span className="date">2020.12 ~ 2021.03</span> 부패방지 종합정보시스템 구축3단계 (퍼블리셔)</li>
                                <li className='dots_w flex' style={z_first}><span className="date">2020.12 ~ 2021.03</span> (주)에이블 정보기술 프리랜서 계약</li>
