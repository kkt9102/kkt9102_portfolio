...
function Ex_pop() {
    return(
        <>
            <ul className="exra_list flex flex_jc_sb">
                <li>
                    <div className="img_box">
                        <img src={cl_icon}></img>
                    </div>
                    <div className="txt_box">
                        <div className="cont_tit">CLOVER</div>
                        <ul className="cont_txt">
                            <li>깊은 풍미에</li>
                ...
                <li>
                    ...
                    <div className="txt_box">
                        <div className="cont_tit">BLACK EAGLE</div>
                        <ul className="cont_txt">
                            <li>진하고 깊은</li>
                            <li>에스프레소 풍미를</li>
                            <li>다체롭게 즐기고 싶다면</li>
                ...
                <li>
                    ...
                    <div className="txt_box">
                        <div className="cont_tit">POUR OVER</div>
                        <ul className="cont_txt">
                            <li>은은한 커피향에</li>
                            <li>부드럽고 깔끔한 풍미를</li>
                            <li>느끼고 싶다면</li>
                ...
                <li>
                    ...
                    <div className="txt_box">
                        <div className="cont_tit">CHEMEX</div>
                        <ul className="cont_txt">
                            <li>풍부한 커피향과</li>
                            <li>균형잡힌 풍미를</li>
                            <li>느끼고 싶다면</li>
                ...
                <li>
                    ...
                    <div className="txt_box">
                        <div className="cont_tit">COLD BREW</div>
                        <ul className="cont_txt">
                            <li>달콤함과 부드러운 풍미를</li>
                            <li>동시에 느끼고 싶다면</li>
                        </ul>
