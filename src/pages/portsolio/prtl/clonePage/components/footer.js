...
const Footer = () => {
    return(
        <>
            <footer className={`${prtl.footer} flex flex_jc_sb`}>
                <div className={`${prtl.left} flex flex_jc_sv`}>
                    <div className={`${prtl.sevice_tel} flex`}>
                        <div>PC유지보수</div>
                        <div>1234(내선)</div>
                    </div>
                    <div className={`${prtl.service_tel} flex`}>
