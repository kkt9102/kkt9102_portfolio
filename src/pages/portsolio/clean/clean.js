            ...
            <div className='con2'>
                ...
                <div className='cont_box cont_1'>
                    ...
                    <div className='sub_txt'>
                        <div>
                            <p>국민권익위원회가 운영하는 부패·공익 신고 홈페이지 이며 퍼블리셔로 취업 후 처음으로 투입 된 공공기관 프로젝트입니다.</p>
                            <p>해당 프로젝트는 3단계 고도화 사업이었으며 저는 프로젝트 후반 개발이 끝난 항목에 대한 퍼블리싱 지원으로 투입된 프로젝트 입니다.</p>
                            <p>해당 프로젝트에서 업무는 홈페이지 구축 사업에서 신고서를 작성하는 페이지들의 서브코딩과 반응형 작업,</p>
                            <p> 청렴포털 내에 있는 청렴마당 홈페이지 탭메뉴 퍼블리싱 등을 진행하였습니다.</p>
                ...
                <div className='cont_box cont_2'>
                    <div className='txt_box flex flex_wrap_wrap'>
                        ...
                        <ul className='link_box flex_jc_c'>
                            <li className='target_move'><a href="https://www.clean.go.kr/" target="_blank" title="청렴포털 홈페이지 새창으로 바로가기"  rel="noreferrer">청렴포털 홈페이지 바로가기 (https://www.clean.go.kr)</a></li>
                        </ul>
                    </div>
