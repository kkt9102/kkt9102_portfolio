...
function RFooter() {
    return(
        <>
            <footer id={`${reserve.reserve_footer}`}>
                <div className={reserve.con}>
                    <nav className={reserve.footer_menu_1}>
                    ...
                    <nav className={reserve.footer_menu_2}>
                    ...
                    <div className={`${reserve.address} flex`}>
                        <div className={reserve.comp_num}>사업자등록번호 : 201-81-21515</div>
                        <div className={reserve.comp_ceo}>주식회사 에스씨케이컴퍼니 대표이사 : 송 데이비드 호섭</div>
                        <div className={reserve.comp_tel}>TEL : 1522-3232</div>
                        <div className={reserve.prvt_responsive}>개인정보 책임자 : 하익성</div>
                    </div>
                    <div className={`${reserve.copyright} flex flex_jc_c`}>ⓒ 2022 Starbucks Coffee Company. All Rights Reserved.</div>
                </div>
            </footer>
        </>
    )
